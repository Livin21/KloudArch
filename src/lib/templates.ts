...
export const TEMPLATES: Template[] = [
  {
    ...
    tagline: "ALB · EC2 · RDS · ROUTED VPC",
    description:
      "Classic web stack in a fully routed VPC: internet gateway, dual-AZ public subnets with a load balancer and NAT, and a private subnet with the EC2 fleet, Postgres and Redis.",
    nodes: [
      n({ id: "tt-users", serviceId: "users", label: "Web Users", x: 40, y: 400 }),
      n({ id: "tt-dns", serviceId: "route53", label: "App DNS", x: 270, y: 400, config: { domain: "app.example.com" } }),
      n({ id: "tt-vpc", serviceId: "vpc", label: "App VPC", x: 520, y: 160, width: 820, height: 560 }),
      n({ id: "tt-igw", serviceId: "internet-gateway", label: "Internet Gateway", x: 560, y: 200 }),
      n({
        id: "tt-pub-a", serviceId: "subnet", label: "Public A", x: 560, y: 310, width: 240, height: 180,
        config: { cidr: "10.0.1.0/24", visibility: "public", az: "a" },
      }),
      n({
        id: "tt-pub-b", serviceId: "subnet", label: "Public B", x: 560, y: 510, width: 240, height: 180,
        config: { cidr: "10.0.2.0/24", visibility: "public", az: "b" },
      }),
      n({
        id: "tt-priv", serviceId: "subnet", label: "Private Subnet", x: 840, y: 310, width: 460, height: 380,
        config: { cidr: "10.0.3.0/24", visibility: "private", az: "a" },
      }),
      n({ id: "tt-alb", serviceId: "alb", label: "Web ALB", x: 585, y: 355, config: { protocol: "HTTP", listener_port: 80 } }),
      n({ id: "tt-nat", serviceId: "nat-gateway", label: "NAT Gateway", x: 585, y: 555 }),
      n({ id: "tt-web", serviceId: "ec2", label: "App Servers", x: 890, y: 345, config: { instance_type: "t3.medium", count: 2 } }),
      n({ id: "tt-db", serviceId: "rds", label: "Primary DB", x: 890, y: 460, config: { engine: "postgres", multi_az: true } }),
      n({ id: "tt-cache", serviceId: "elasticache", label: "Session Cache", x: 890, y: 570 }),
      n({ id: "tt-logs", serviceId: "cloudwatch", label: "Monitoring", x: 270, y: 580 }),
    ],
    edges: [
      e({ id: "tt-e1", source: "tt-users", target: "tt-dns", label: "dns lookup" }),
      e({ id: "tt-e2", source: "tt-dns", target: "tt-alb", label: "http 80" }),
